...
public class ConsultaControladorClienteTest {
	...
	public void listar() throws Exception {
		...
		// act - assert
		mocMvc.perform(get("/cliente").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		.andExpect(jsonPath("$", hasSize(1))).andExpect(jsonPath("$[0].nombres", is("test")));
	}
