...
INSERT INTO parametro(id, enumParametro, valor, descripcion) VALUES ( 1, HORA_ENTRADA,8, 'Hora en la que se empieza a atender' );
INSERT INTO parametro(id, enumParametro, valor, descripcion) VALUES ( 2, HORA_SALIDA,20, 'Hora en la que termina de atender' );
...
INSERT INTO cliente(id, nombres , apellidos , identificacion,email,fecha_creacion) VALUES ( 2, 'David','Marin Santafe', 123457, 'jMarin@mail.com', now() );
INSERT INTO compra (id, idCliente , total , fechaCompra,fechaEntrega) VALUES ( 1, 1,20000, now(), now() );
INSERT INTO itemsCompra(id, cantidad , idCompra , valor, ancho,largo,fecha_creacion) VALUES ( 1, 1,1, 20000, 2, 2, now() );
